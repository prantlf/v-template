...
For [example](string_map_test.v), a map `string` to `string`:
...
For [example](string_array_map_test.v), a map `string` to `[]string`:
...
For [example](two_maps_test.v), a struct `MapData` with separate maps `string` to `string` and `string` to `[]string`:
...
For [example](struct_test.v), a struct `Data` with fields of types `string` and `[]string` instead of a map:
